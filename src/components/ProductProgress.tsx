...
const improvements = [
  { title: '全景彗星定位与轨迹控制（本地验收）', detail: '哈雷与 67P 支持彗核和名称点选、同场景定位、日期跟随、日心参数及黄道高度。两年路径与参考椭圆分别开关；背日箭头长度固定，彗尾另有明确标注非当日活动的示例定位。受阶段 02 控制，不新增目标或事件数据。' },
  { title: '全景冥王星—卡戎（本地验收）', detail: '冥王星与卡戎可在同一全景中定位、点选并按日期运行，补双体质心、参考轨道、相对距离、速度和黄道高度。局部半径与间距统一比例，外部距离仍压缩；与阶段 04、卫星图层及区域冥王星入口关联。本轮不新增目标，另四颗冥王星卫星尚未导入。' },
  { title: '全景卫星与环系（本地验收）', detail: '地月、火星及四大巨行星家族直接接入综合全景，共 20 颗已有卫星。支持同场景定位、球体和名称点选、相对母星参数、前后一天与播放公转；四大巨行星环和参考轨道分别开关，并受阶段 04 控制。距离与大小为展示缩放，后续已将卡戎补入全景双体模块，没有新增目标。' },
  { title: '综合全景整合（本地验收）', detail: '太阳活动、地球磁层与粒子带、碎屑流和流星示例、日鞘与星际介质已绘入同一个宏观画布。点击标记或全景现象定位，地球周围效果跟随历表位置；支持开关、独立进度与原视角返回。独立课程作为进一步阅读入口。' },
  { title: '第九批：日球层与星际空间（本地验收）', detail: '展开六类环境图层，支持剖示、完整轮廓、侧视与独立流动演示；说明太阳风边界不等于引力终点，关联奥尔特云和太阳活动。球面不是实测外形，不接入探测器轨迹。' },
  ...
  { title: '宏观优化已发布', detail: '第一至第八批已随 0b3d801 完成部署，提交正文包含功能、来源边界和验证。第九批、综合全景整合与全景卫星环系仅在本地验收，尚未推送。' },
