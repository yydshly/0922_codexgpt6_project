...
export type IntegratedTarget=PhenomenonTarget|MacroFamilyId|CometId|'comet-demo'|'pluto-system';
...
export const INTEGRATED_FOCUS_DISTANCE:Record<IntegratedTarget,number>={'comet-demo':8,halley:3.2,'67p':3.2,'pluto-system':6.5,sun:6,earth:3.4,dust:13,helio:29,mars:2.8,jupiter:2.7,saturn:2.7,uranus:2.7,neptune:2.7};
