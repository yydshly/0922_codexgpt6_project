...
const improvements = [
  { title: '第三批：观察路径串联（本地验收）', detail: '综合全景新增上一步 / 下一步、当前位置提示及推荐观察顺序，串联区域、本体、卫星、彗星、双体与现象。恢复离开时的镜头、基础图层和卫星选择，按当前日期重新对准天体，不回退时间；阶段关闭时说明原因。本次太阳系全景内最多保留 12 个过去位置，关闭或转入星系视图后清空。窄窗口支持滚动到完整侧栏。剩余第四批综合验收。' },
