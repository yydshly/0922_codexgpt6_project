...
export const SOLAR_FAMILIES: readonly LearningItem<SolarFamilyId>[] = [
  { id: 'moons', name: '天然卫星', english: 'NATURAL SATELLITES', keyFact: '围绕行星或矮行星运行', description: '月球、木卫一、土卫六等有各自的轨道、表面与物理特征。本项目已有 21 颗选定卫星的动态历表；它们不是太阳系卫星总数。', status: '21 颗选定卫星已接入动态历表', visualMeaning: '综合全景按当日历表显示月球及 19 颗扩展卫星；在全景现象中定位六个家族，点击名称查看相对母星参数。局部距离和大小分别缩放，细线为参考轨道；卡戎可在同一全景的冥王星双体模块中展开。', sourceUrl: 'https://science.nasa.gov/solar-system/moons/facts/', sourceLabel: 'NASA 卫星资料', exampleId: 'io', exampleName: '木卫一' },
