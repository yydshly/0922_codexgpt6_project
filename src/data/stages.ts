...
export const STAGES = [
 ...
 {id:'families',title:'04 · 卫星家族与环系',added:'六个行星家族与四大巨行星环系',description:'综合全景接入地月、火星及四大巨行星家族，可原位定位、点选卫星并切换日期。四大巨行星环与参考轨道分别开关。',evidence:'卫星沿用真实历表；环的参考尺度有来源，细环宽度和亮度可增强。本批不新增卫星数量。',how:'综合全景 → 全景现象 → 定位家族 → 点选卫星 → 前后 1 天或播放公转。'},
