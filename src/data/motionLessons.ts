...
export function motionStepSeconds(id:MotionLessonId){return id==='moon-phase'?3*86400:(id==='earth-orbit'||id==='earth-seasons')?30*86400:spinPeriodSeconds(id==='venus-spin'?'venus':'earth')/4;}
...
export function motionCycleSeconds(id:MotionLessonId){return id==='moon-phase'?MEAN_PHASE_DAYS*86400:(id==='earth-orbit'||id==='earth-seasons')?bodyById.earth.orbitalPeriodDays*86400:spinPeriodSeconds(id==='venus-spin'?'venus':'earth');}
