...
try{
 ...
 for(let i=0;i<200&&!await run("!!document.querySelector('[data-motion-lessons]')&&!!document.querySelector('.home-time input')?.value");i++)await wait(100);
