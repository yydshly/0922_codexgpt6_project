...
20 类主题与 5 项必补均有入口、证据和验收动作；逐类画面复验仍待执行。
...
第 1 步完成整理；第 2 步已建立 20 类主题 + 5 项必补的代码/证据核对表，逐类画面复验仍待执行；第 3—5 步继续推进。这不是五次提交或完成百分比，也不是所有星体都已收录。
...
已有证据：[R04-APPEARANCE.md](../docs/R04-APPEARANCE.md)、[TEXTURE-LOADING.md](../docs/TEXTURE-LOADING.md)。
...
已有证据：[R03-SYSTEMS-AND-RINGS.md](../docs/R03-SYSTEMS-AND-RINGS.md)、[TOPIC-FAMILY-ACCEPTANCE.md](../docs/TOPIC-FAMILY-ACCEPTANCE.md)。
...
已有证据：[R03-SYSTEMS-AND-RINGS.md](../docs/R03-SYSTEMS-AND-RINGS.md)。
...
已有证据：[R07-TOPIC-ROUTES.md](../docs/R07-TOPIC-ROUTES.md)。
...
已有证据：[R01-SMALL-BODIES.md](../docs/R01-SMALL-BODIES.md)、[R07-TOPIC-ROUTES.md](../docs/R07-TOPIC-ROUTES.md)。
...
已有证据：[PHENOMENA-AUDIT.md](../docs/PHENOMENA-AUDIT.md)、[EVENT-ACCEPTANCE.md](../docs/EVENT-ACCEPTANCE.md)。
...
已有证据：[R08-STELLAR-CONTEXT.md](../docs/R08-STELLAR-CONTEXT.md)、[R09-VALIDATION.md](../docs/R09-VALIDATION.md)。关联未关闭事项：F01。
...
已有证据：[R08-STELLAR-CONTEXT.md](../docs/R08-STELLAR-CONTEXT.md)。
