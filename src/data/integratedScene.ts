...
export const INTEGRATED_FOCUS_DISTANCE:Record<IntegratedTarget,number>={'body:sun':3,'body:mercury':1.3,'body:venus':1.3,'body:earth':1.5,'body:mars':1.3,'body:jupiter':2,'body:saturn':2,'body:uranus':2,'body:neptune':2,'comet-demo':8,halley:3.2,'67p':3.2,'pluto-system':6.5,sun:6,earth:3.4,dust:13,helio:29,mars:2.8,jupiter:2.7,saturn:2.7,uranus:2.7,neptune:2.7};
