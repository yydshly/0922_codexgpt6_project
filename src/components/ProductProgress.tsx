  ...
  return <div className="product-progress-overlay" role="presentation" onMouseDown={event => { if (event.target === event.currentTarget) onClose(); }}>
    <section className="product-progress-dialog" role="dialog" aria-modal="true" aria-labelledby="product-progress-title">
      ...
      <div className="product-progress-content">
        ...
        <section className="product-progress-next" data-validation-summary data-release="2026.09.25-r09.3"><h3>本次交付：2026.09.25-r09.3</h3><p>主全景右侧新增可折叠的“全景表面贴图”：查看太阳、行星、月球与云层的外观素材状态；等待过久或失败可仅重试未就绪项，保留日期、镜头和课程。</p><p>326 项自动检查通过。已验证三张贴图失败后恢复、30 秒等待、迟到结果隔离，以及三种窗口大小下的操作。实际设备长期体验与用户总验收仍待完成。</p><a href={textureLoadingNotesUrl} download="TEXTURE-LOADING.md">下载外观素材恢复与验收说明</a><br/><a href={ephemerisLoadingNotesUrl} download="EPHEMERIS-LOADING.md">查看历表加载与恢复说明</a><br/><a href={loadingNotesUrl} download="LOADING-OPTIMIZATION.md">查看窗口加载优化</a><br/><a href={releaseNotesUrl} download="RELEASE-2026-09-25.md">查看完整功能交付范围</a></section>
