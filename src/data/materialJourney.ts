...
export const MATERIAL_STEPS=[
 ...
 {id:'stream',name:'碎屑分布',stage:'dustExplorer',title:'碎屑流：物质沿轨道附近分布',text:'彗星释放的尘粒可逐渐分散；地球经过碎屑分布区域时可能产生流星雨。也有与小行星有关的流星雨，不能把所有流星都归给彗星。',legend:'青色点带是通用倾斜分布示意，点数和点大小作显示增强，没有对应某一场流星雨；不根据当前日期预测相交。',source:'https://science.nasa.gov/solar-system/meteors-meteorites/meteor-showers/'},
