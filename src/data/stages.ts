...
export const STAGES = [
 ...
 {id:'comets',title:'02 · 真实彗星',added:'哈雷与 67P 按日期运行',description:'两颗彗星可在综合全景点选、定位并随日期跟随，查看距离、速度和黄道高度；两年路径、参考椭圆与背日箭头分别控制，彗尾示例独立定位。',evidence:'位置、速度来自 JPL；淡线为参考椭圆，彗尾不是当日实测活动。',how:'综合全景 → 全景现象 → 定位彗星 → 前后 30 天 → 对比两类轨迹和彗尾示例。'},
 {id:'members',title:'03 · 区域真实成员',added:'4 个新增天体与区域入口',description:'增加灶神星、妊神星、鸟神星、阋神星，与谷神星、冥王星串成全景成员清单，可原位定位、随日期跟随并查看日心参数。',evidence:'位置来自 JPL；球体尺寸放大，近景外观为示意。',how:'全景现象 → 区域成员 → 前后 30 天 → 对比参数 → 查看所属区域。'},
