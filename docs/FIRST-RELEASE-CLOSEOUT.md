...
当前规划版本 2026.09.26-r09.12；能力基线 r09.3 已上线。本版范围冻结，执行性能检查、最终回归和用户验收三步；详见 FINAL-TECHNICAL-REPORT.md；太阳系动态天体数量未变。用户总验收未完成。

## 本版固定的三步收尾

### 1 · 性能检查

状态：本地通过，线上待复测。固定设备、窗口及网络条件；只修打不开、卡死、影响正常使用的问题。

### 2 · 最终回归

状态：集中回归中。全景、区域、天体、说明与返回；日期、运动和按钮对应。
...
主全景星表背景已接入并验证；资源预算、完整子项与异常检查继续，不将技术修复当作用户验收。

### C04 · 完成性能验收

状态：参考环境测量通过，线上与实机待确认。
