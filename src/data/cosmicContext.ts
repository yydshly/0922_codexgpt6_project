...
export const SOLAR_FAMILIES: readonly LearningItem<SolarFamilyId>[] = [
  { id: 'moons', name: '天然卫星', english: 'NATURAL SATELLITES', keyFact: '围绕行星或矮行星运行', description: '月球、木卫一、土卫六等有各自的轨道、表面与物理特征。本项目已有 21 颗选定卫星的动态历表；它们不是太阳系卫星总数。', status: '21 颗选定卫星已接入动态历表', visualMeaning: '行星旁的小圆点和同心小圈只是卫星系统标记，不是这些卫星的实时位置或真实轨道。要看已接入的真实运动，请进入行星卫星观测。', sourceUrl: 'https://science.nasa.gov/solar-system/moons/facts/', sourceLabel: 'NASA 卫星资料', exampleId: 'io', exampleName: '木卫一' },
  { id: 'dwarfs', name: '矮行星', english: 'DWARF PLANETS', keyFact: '有的在主带，有的在海王星外', description: '谷神星在小行星主带，冥王星、妊神星、鸟神星和阋神星属于更遥远的区域。它们并非太阳的卫星，也不全在同一圈。', status: '谷神星与冥王星已接入历表；其余三颗矮行星仍为图鉴资料', visualMeaning: '谷神星与冥王星的小球取当前历表位置，轨道线为当前状态推得的参考椭圆。卡戎与冥王星在宏观尺度不可分辨；阋神星尚未接入动态观测。', sourceUrl: 'https://science.nasa.gov/dwarf-planets/', sourceLabel: 'NASA 矮行星资料', exampleId: 'ceres', exampleName: '谷神星' },
  { id: 'asteroids', name: '小行星与近地天体', english: 'ASTEROIDS / NEOS', keyFact: '主带之外也有小行星', description: '许多小行星在火星和木星之间；近地天体与行星的轨道区域可能交叉。画面主带颗粒表示空间范围，不是已编目的逐颗小行星。', status: '主带为区域示意；谷神星与灶神星有图鉴资料', visualMeaning: '主带颗粒是固定随机样本，表示有厚度的稀疏区域；不代表逐颗小行星、近地天体的数量、大小或位置。', sourceUrl: 'https://science.nasa.gov/asteroids-comets-meteors/facts/', sourceLabel: 'NASA 小天体资料', exampleId: 'vesta', exampleName: '灶神星' },
  { id: 'comets', name: '彗星', english: 'COMETS', keyFact: '长轨道可跨越多个区域', description: '彗星是冰与尘埃等组成的小天体，接近太阳时可能形成彗发与彗尾。短周期与长周期彗星的来源不同，不能把彗星画成固定的一条环带。', status: '67P 彗星已有资料与外观示意，尚无本项目动态历表', visualMeaning: '倾斜曲线来自 JPL 哈雷彗星指定历元的轨道根数，是参考椭圆；近太阳的彗核、彗发、蓝色离子尾与暖色尘埃尾为固定活动示意，不是当前哈雷或 67P 的状态。', sourceUrl: 'https://science.nasa.gov/solar-system/comets/facts/', sourceLabel: 'NASA 彗星资料', exampleId: '67p', exampleName: '67P 彗星' },
