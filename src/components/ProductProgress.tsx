...
import dialogLoadingUrl from '../../docs/DIALOG-LOADING-RECOVERY.md?url';
import panoramaStarsUrl from '../../docs/F01-PANORAMA-STARS.md?url';
import supplementAuditUrl from '../../docs/C02-SUPPLEMENT-COVERAGE-AUDIT.md?url';
import contextAuditUrl from '../../docs/C02-CONTEXT-COVERAGE-AUDIT.md?url';
import environmentAuditUrl from '../../docs/C02-ENVIRONMENT-COVERAGE-AUDIT.md?url';
import outerAuditUrl from '../../docs/C02-OUTER-COVERAGE-AUDIT.md?url';
import coreAuditUrl from '../../docs/C02-CORE-COVERAGE-AUDIT.md?url';
import closeoutNotesUrl from '../../docs/FIRST-RELEASE-CLOSEOUT.md?url';
import textureLoadingNotesUrl from '../../docs/TEXTURE-LOADING.md?url';
import ephemerisLoadingNotesUrl from '../../docs/EPHEMERIS-LOADING.md?url';
  ...
  return <div className="product-progress-overlay" role="presentation" onMouseDown={event => { if (event.target === event.currentTarget) onClose(); }}>
    <section className="product-progress-dialog" role="dialog" aria-modal="true" aria-labelledby="product-progress-title">
      ...
      <div className="product-progress-content">
        ...
        <section className="product-progress-next" data-validation-summary data-release="2026.09.26-r09.12"><h3>2026.09.26-r09.12 · 本轮验收通过，已冻结</h3><p>用户反馈当前未发现问题，确认本轮通过。后续问题另行登记，不自动继续优化；不推定已完成逐项、跨设备或长时验证。</p><a href={acceptanceRecordUrl} download="ACCEPTANCE-RECORD.md">查看验收通过与冻结记录</a><br/><p>本版范围冻结，只做性能检查、最终回归和用户验收。已修复贴图超时后仍占连接的问题：最多两张并行，超时或退出会取消请求。本地与线上受限网络测量、60 次切换、七组 183 个操作检查点通过。前两轮技术收尾完成，本轮用户确认已完成，五步清单保留供后续复查。</p><a href={finalReportUrl} download="FINAL-TECHNICAL-REPORT.md">查看集中技术收尾结果</a> · <a href={acceptanceUrl} download="FINAL-ACCEPTANCE.md">下载五步用户验收清单</a><br/><p>r09.11 已统一补齐资料窗口的慢加载恢复：等待超过 12 秒会显示说明，关闭保留观察，主动重载提示状态重置；延迟加载成功后自动显示内容，关闭后不会自行弹回。建设记录的线上文件在隔离浏览器中正常返回，旧测试会话的网络停滞原因尚未完全确认，不能归为文件缺失。该阶段的 F02 待办现已由本轮集中测量补齐。</p><a href={dialogLoadingUrl} download="DIALOG-LOADING-RECOVERY.md">查看慢加载修复与验收记录</a><br/><p>F01：主全景的随机星点已替换为 2,936 个 Hipparcos-2 亮星方向。点选可查 HIP 编号并进入同一恒星视图；新增显隐、来源、固定历元说明与失败重试。坐标旋转及 5 个归算版本检查点通过，F01 实现差距关闭；F02 已完成工程检查，F03/F04 按当前使用反馈与确认关闭，详见冻结记录。</p><a href={panoramaStarsUrl} download="F01-PANORAMA-STARS.md">查看星表背景接入、方向验证与截图</a><br/><a href={supplementAuditUrl} download="C02-SUPPLEMENT-COVERAGE-AUDIT.md">查看五项必补检查、修复截图与剩余范围</a><br/><a href={contextAuditUrl} download="C02-CONTEXT-COVERAGE-AUDIT.md">查看第四组检查、截图与剩余范围</a><br/><a href={environmentAuditUrl} download="C02-ENVIRONMENT-COVERAGE-AUDIT.md">查看第三组空间环境检查</a><br/><a href={outerAuditUrl} download="C02-OUTER-COVERAGE-AUDIT.md">查看第二组小天体检查</a><br/><a href={coreAuditUrl} download="C02-CORE-COVERAGE-AUDIT.md">查看第一组六类核心检查</a><p>总规划默认打开“收尾进度”：三步冻结收尾与既有五步台账、20 类主题与 5 项必补核对表、0 项本版未关闭事项与 F01–F04 收尾记录。已上线、既有验证和用户验收分别记录；本轮冻结已确认的认知版范围，不宣称收录全部天体或实现全部科学细节。</p><p>修正旧规划把准卫星、运动课程和真实星表写成待实现的问题。网页与四份规划文档共用台账，构建时检查同步；旧记录归档，个人旧版验收存储保留。</p><a href={closeoutNotesUrl} download="首版收尾与25项核对表.md">下载五步收尾与25项核对表</a><br/><a href={textureLoadingNotesUrl} download="TEXTURE-LOADING.md">查看外观素材恢复</a><br/><a href={ephemerisLoadingNotesUrl} download="EPHEMERIS-LOADING.md">查看历表恢复</a><br/><a href={loadingNotesUrl} download="LOADING-OPTIMIZATION.md">查看窗口加载优化</a><br/><a href={releaseNotesUrl} download="RELEASE-2026-09-25.md">查看完整功能交付范围</a></section>
