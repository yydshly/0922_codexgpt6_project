...
export const R01_ATLAS:AtlasBody[] = [
 ...
 {id:'chariklo',name:'女凯龙星',englishName:'10199 Chariklo',category:'small',parent:'太阳',radiusKm:null,radiusNote:'不指定唯一半径：SBDB 保留较早的 302 ± 30 km 有效直径估计，其他观测与形状模型会给出不同尺度；下方参数保留原文献。',color:'#b4c1ce',appearance:'ice',description:'在巨行星区域绕太阳运行的半人马族天体。恒星掩星观测发现它拥有环，说明环并非巨行星独有；本批接入本体轨道，环的近景留给 R03。',features:['半人马族不是均匀完整的一条环带','有环的观测证据与本体球形标记应分开理解','真实形状、环平面与自转姿态本批未重建'],sourceUrl:'https://science.nasa.gov/solar-system/asteroids/10199-chariklo/'},
];
