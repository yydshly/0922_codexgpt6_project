...
export const STAGES = [
 ...
 {id:'members',title:'03 · 区域真实成员',added:'10 个扩展天体与区域入口',description:'增加灶神星、妊神星、鸟神星、阋神星，以及 R01 的爱神星、L4/L5 代表和女凯龙星，以及 R02 的夸奥尔、塞德娜，与谷神星、冥王星串成全景成员清单，可原位定位、随日期跟随并查看日心参数。',evidence:'位置来自 JPL；球体尺寸放大，近景外观为示意。',how:'全景现象 → 区域成员 → 前后 30 天 → 对比参数 → 查看所属区域。'},
