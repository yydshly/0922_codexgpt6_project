...
export function MacroFamilyPanel(p:Props){
 ...
 return <section className="panorama-families" aria-label="全景卫星与环系">
  ...
  <details><summary>位置、轨道线与环分别代表什么？</summary><p>卫星位置和速度读取已有 NASA/JPL NAIF SPK 内核生成的月度数据包，以母星为参照；月球取主历表中的月球减去地球。每次日期变化重新插值，缺少该月数据时隐藏对应卫星。</p><p>细线是当前位置、速度构成的瞬时二体参考椭圆，约每 30 分钟观测时间刷新；不是实测完整路径，也不是实体环。环由绕母星公转的颗粒组成，本图用有来源的环段尺度和说明性亮度绘制；没有逐粒子模拟。</p><p>行星表面使用静态贴图，卫星使用示意颜色；局部球体尺寸与距离分别缩放。冥王星—卡戎仍在专门近景中，此处不代表完整卫星名录。</p><a href="https://ssd.jpl.nasa.gov/horizons/manual.html" target="_blank" rel="noreferrer">主历表 Horizons 数据说明 ↗</a><br/><a href="https://naif.jpl.nasa.gov/pub/naif/generic_kernels/spk/satellites/" target="_blank" rel="noreferrer">扩展卫星 NAIF SPK 来源 ↗</a></details>
 </section>;
}
