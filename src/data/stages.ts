...
export const STAGES = [
 ...
 {id:'comets',title:'02 · 真实彗星',added:'哈雷、67P 与海尔—波普按日期运行',description:'三颗彗星可在综合全景点选、定位并随日期跟随，查看距离、速度和黄道高度；两年路径、参考椭圆与背日箭头分别控制，彗尾示例独立定位。',evidence:'位置、速度来自 JPL；淡线为参考椭圆，彗尾不是当日实测活动。',how:'综合全景 → 全景现象 → 定位彗星 → 前后 30 天 → 对比两类轨迹和彗尾示例。'},
 {id:'members',title:'03 · 区域真实成员',added:'区域代表与地球准卫星入口',description:'增加灶神星、妊神星、鸟神星、阋神星，以及 R01 的爱神星、L4/L5 代表和女凯龙星，以及 R02 的夸奥尔、塞德娜，与谷神星、冥王星串成全景成员清单，可原位定位、随日期跟随并查看日心参数。Kamoʻoalewa 准卫星在全景标记中定位，可切换日心与地心旋转参照系。',evidence:'位置来自 JPL；球体尺寸放大，近景外观为示意。',how:'全景现象 → 区域成员 → 前后 30 天 → 对比参数 → 查看所属区域。'},
 {id:'families',title:'04 · 卫星家族与环系',added:'六个行星家族、两个矮行星系统与环系',description:'综合全景接入地月、火星及四大巨行星家族，可原位定位、点选卫星并切换日期。四大巨行星环与参考轨道分别开关；冥王星五颗卫星按同日历表展开，可观察中央双体与外围四颗小卫星。土卫二另有主全景近景、喷流与内部剖示。开启阶段 03 后，还可观察阋神星—阋卫一系统和女凯龙星双环尺寸示意。',evidence:'卫星沿用真实历表；环的参考尺度有来源，细环宽度和亮度可增强。冥王星新增四颗小卫星也受此阶段控制。',how:'综合全景 → 全景现象 → 定位家族 → 点选卫星 → 前后 1 天或播放公转。'},
 {id:'environment',title:'05 · 地球与木星空间环境',added:'太阳风、磁层、极光与木卫一物质供给',description:'主全景七步串联太阳、太阳风、地球磁层与极光，再对照木星磁层、木卫一等离子体环和极光。木卫一步骤需同时开启阶段 04。',evidence:'依据 NASA 科学说明绘制；不是当天实测。天体锚点读取当日历表；两处镜头独立缩放，磁层、粒子云、磁轴与光带仍是教学示意。',how:'全景现象 → 太阳与行星环境 → 先地球再木星；各步图例与 NASA 来源对应，更多工具仍提供近地独立详解。'},
 ...
 {id:'solarActivity',title:'07 · 太阳活动与物质抛射',added:'太阳大气分层、黑子、日珥与爆发区别',description:'主全景由光球向外逐层叠加色球、过渡区与日冕，再对照黑子、日珥、耀斑和 CME。分项可开关；耀斑和 CME 使用独立演示进度，太阳风仍独立控制。',evidence:'依据 NASA 科学说明；纹理、光晕、云团和传播节奏为示意，不是当日事件或抵达时间预测。',how:'场景清单 → 太阳活动 → 光球到日冕 → 黑子与日珥 → 对照耀斑与 CME → 地球磁层。'},
