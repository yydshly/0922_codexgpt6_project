...
export function CloseoutPlan({ onTopic }: { onTopic: (id: string) => void }) {
 return <section className="closeout-plan" data-closeout>
  <h3>首版收尾 · 固定五步</h3>
  <p>当前版本 {CURRENT_RELEASE.version}。第 1 步已整理；第 2 步已有 20 类主题与 5 项必补的核对表，逐类画面复验仍待完成。第 3—5 步继续执行。工作包不等于修改次数，不按提交数量估算完成率。</p>
  ...
  <p>以下已核对代码入口与既有报告，不代表本轮重新逐项完成视觉验收。已上线、验证依据、用户验收分别记录；所有用户验收保持待确认。</p>
