...
export const SOLAR_FAMILIES: readonly LearningItem<SolarFamilyId>[] = [
  { id: 'moons', name: '天然卫星', english: 'NATURAL SATELLITES', keyFact: '围绕行星或矮行星运行', description: '月球、木卫一、土卫六等有各自的轨道、表面与物理特征。本项目已有 20 颗选定卫星的动态历表；它们不是太阳系卫星总数。', status: '20 颗选定卫星已接入动态历表', visualMeaning: '行星旁的小圆点和同心小圈只是卫星系统标记，不是这些卫星的实时位置或真实轨道。要看已接入的真实运动，请进入行星卫星观测。', sourceUrl: 'https://science.nasa.gov/solar-system/moons/facts/', sourceLabel: 'NASA 卫星资料', exampleId: 'io', exampleName: '木卫一' },
  { id: 'dwarfs', name: '矮行星', english: 'DWARF PLANETS', keyFact: '有的在主带，有的在海王星外', description: '谷神星在小行星主带，冥王星、妊神星、鸟神星和阋神星属于更遥远的区域。它们并非太阳的卫星，也不全在同一圈。', status: '现有图鉴提供资料与外观示意，未接入本项目逐体历表', visualMeaning: '主带与海王星外的彩色小球只标出几个示例所在的区域，不是谷神星、冥王星或阋神星的当前坐标。', sourceUrl: 'https://science.nasa.gov/dwarf-planets/', sourceLabel: 'NASA 矮行星资料', exampleId: 'ceres', exampleName: '谷神星' },
  ...
  { id: 'comets', name: '彗星', english: 'COMETS', keyFact: '长轨道可跨越多个区域', description: '彗星是冰与尘埃等组成的小天体，接近太阳时可能形成彗发与彗尾。短周期与长周期彗星的来源不同，不能把彗星画成固定的一条环带。', status: '67P 彗星已有资料与外观示意，尚无本项目动态历表', visualMeaning: '斜着的椭圆线、亮点和尾迹共同示意一颗彗星的轨道与近太阳活动，不是 67P 的历表轨道、当前位置或实时彗尾。', sourceUrl: 'https://science.nasa.gov/solar-system/comets/facts/', sourceLabel: 'NASA 彗星资料', exampleId: '67p', exampleName: '67P 彗星' },
