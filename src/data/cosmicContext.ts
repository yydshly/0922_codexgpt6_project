...
export const SOLAR_FAMILIES: readonly LearningItem<SolarFamilyId>[] = [
  { id: 'moons', name: '天然卫星', english: 'NATURAL SATELLITES', keyFact: '围绕行星或矮行星运行', description: '月球、木卫一、土卫六等有各自的轨道、表面与物理特征。本项目已有 26 颗选定卫星的动态历表；它们不是太阳系卫星总数。', status: '26 颗选定卫星已接入动态历表', visualMeaning: '综合全景按当日历表显示月球及 19 颗扩展卫星；在全景现象中定位六个家族，点击名称查看相对母星参数。局部距离和大小分别缩放，细线为参考轨道；冥王星五颗卫星可在同一全景家族中展开，其中四颗小卫星标记可关闭放大；阋神星—阋卫一也已进入同一主全景。', sourceUrl: 'https://science.nasa.gov/solar-system/moons/facts/', sourceLabel: 'NASA 卫星资料', exampleId: 'io', exampleName: '木卫一' },
  { id: 'dwarfs', name: '矮行星', english: 'DWARF PLANETS', keyFact: '有的在主带，有的在海王星外', description: '谷神星在小行星主带，冥王星、妊神星、鸟神星和阋神星属于更遥远的区域。它们并非太阳的卫星，也不全在同一圈。', status: '五颗矮行星均已接入宏观历表；谷神星与冥王星另有主观测入口', visualMeaning: '五颗带名称的小球均取当日历表位置，轨道线是当前状态的参考椭圆。卡戎可从全景现象进入局部等比例双体观察；其余矮行星的卫星尚未展开。', sourceUrl: 'https://science.nasa.gov/dwarf-planets/', sourceLabel: 'NASA 矮行星资料', exampleId: 'ceres', exampleName: '谷神星' },
  { id: 'asteroids', name: '小行星与近地天体', english: 'ASTEROIDS / NEOS', keyFact: '主带之外也有小行星', description: '许多小行星在火星和木星之间；近地天体与行星的轨道区域可能交叉。画面主带颗粒表示空间范围，不是已编目的逐颗小行星。', status: '谷神星、灶神星及近地代表爱神星可点选；主带点云为示意', visualMeaning: '主带颗粒是固定随机样本，表示有厚度的稀疏区域；不代表逐颗小行星、近地天体的数量、大小或位置。', sourceUrl: 'https://science.nasa.gov/asteroids-comets-meteors/facts/', sourceLabel: 'NASA 小天体资料', exampleId: 'vesta', exampleName: '灶神星' },
  { id: 'comets', name: '彗星', english: 'COMETS', keyFact: '长轨道可跨越多个区域', description: '彗星是冰与尘埃等组成的小天体，接近太阳时可能形成彗发与彗尾。短周期与长周期彗星的来源不同，不能把彗星画成固定的一条环带。', status: '全景已接入哈雷、67P 与海尔—波普的 2026—2027 年历表；另有 2I/Borisov 独立历史窗口；不参与十体引力推演', visualMeaning: '带名称的彗核按日期定位；亮线为两年历表路径，淡线为当前状态的参考椭圆。可选近太阳双尾用于解释活动原理，位置与尾长不表示当日状态。', sourceUrl: 'https://science.nasa.gov/solar-system/comets/facts/', sourceLabel: 'NASA 彗星资料', exampleId: '67p', exampleName: '67P 彗星' },
  { id: 'centaurs', name: '半人马族与特洛伊群', english: 'CENTAURS / TROJANS', keyFact: '与巨行星轨道相互关联', description: '半人马族多在巨行星之间活动；特洛伊天体在行星轨道附近的拉格朗日区域聚集。它们不是第九颗行星，也不是一条独立均匀的带。', status: '已接入阿喀琉斯（L4）、埃涅阿斯（L5）与女凯龙星历表', visualMeaning: '巨行星之间及其轨道附近的颗粒是固定随机样本，分别提示半人马族与特洛伊群可能活动的范围；并非编目天体坐标。带名称的三个代表使用 JPL 历表，可在下方选择并定位。', sourceUrl: 'https://science.nasa.gov/learn/basics-of-space-flight/chapter1-3/', sourceLabel: 'NASA 小天体分类资料' },
...
export const COSMIC_LEVELS: readonly LearningItem<CosmicLevelId>[] = [
  { id: 'neighbors', name: '邻近恒星与星空', english: 'CATALOGUE STARS / SOLAR NEIGHBORHOOD', keyFact: '方向与距离，分开观察', description: '太阳是一颗恒星。天空看似相邻的两个亮点，可能处于完全不同的距离。本页用真实星表样本区分天球方向和三维空间位置；它们不计入太阳系成员。', status: 'Hipparcos-2 星表 · J1991.25 固定参考时刻 · 邻星 32 条，亮星方向 2,936 条', visualMeaning: '空间模式以太阳为原点，三轴光年同比例；星空模式固定太阳视点，只保留赤经赤纬方向。光点统一着色、尺寸增强，不代表恒星真实大小或温度。辅助圈为赤道参考，不是轨道。', sourceUrl: 'https://cdsarc.cds.unistra.fr/viz-bin/cat/I/311', sourceLabel: 'CDS Hipparcos 修订星表' },
