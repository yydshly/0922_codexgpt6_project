...
export type IntegratedTarget=typeof INTEGRATED_ITEMS[number]['target'];
...
export const INTEGRATED_FOCUS_DISTANCE:Record<IntegratedTarget,number>={sun:6,earth:3.4,dust:13,helio:29};
export function integratedDetailVisible(target:IntegratedTarget,distance:number,focused:IntegratedTarget|null){
