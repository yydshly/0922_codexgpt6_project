...
export const CONTENT_COVERAGE:CoverageItem[] = [
  ...
  },
  {
    ...
    "title": "真实恒星背景与邻星",
    "status": "部分满足 · 背景差距",
    "current": "独立恒星视图提供 2,936 个亮星方向及 32 个邻星距离样本；主全景复用亮星方向并支持 HIP 点选，固定于 J1991.25。",
    "target": "F01 实现差距已修复并完成方向与交互检查；固定历元、不提供主全景恒星距离，不等于当前夜空或用户验收通过。",
    "phase": "M2 / M5",
    ...
    "stages": [],
    "how": "恒星系统与其他星系 → 邻近恒星；切换天空方向/空间距离并点选资料。主全景底部“星表背景”可查看出处，也可点选星点查询 HIP 编号。",
