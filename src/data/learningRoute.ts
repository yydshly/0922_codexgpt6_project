...
export const LEARNING_STEPS:LearningStep[]=[
 ...
 {id:'moon',chapter:2,title:'地月：从母星到卫星',path:'太阳系 › 地球 › 月球',why:'沿用刚才的地球，扩大局部视野理解卫星关系。',look:'点选月球，查看相对地球的距离与速度；改变日期观察相对位置。',boundary:'天体共享观测日期；局部大小与间距有展示缩放。',destination:{kind:'target',id:'earth'},stages:['families']},
